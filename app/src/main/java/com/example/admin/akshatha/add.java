...
Integer a,b,c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1 = (TextView)findViewById(R.id.ad_textView5);
        ed1 = (EditText)findViewById(R.id.ad_editText);
        tv2 = (TextView)findViewById(R.id.ad_textView4);
        newprob();
    }
    ...
    public void newprob(){
        Random r = new Random();
        a = r.nextInt( 10000 - 900) + 9000;
        b = r.nextInt( 10000 - 900) + 10000;
        tv1.setText("+ "+b+" ");
        tv2.setText("  " + a+" ");
        c = a+b;
        ed1.getText().clear();
